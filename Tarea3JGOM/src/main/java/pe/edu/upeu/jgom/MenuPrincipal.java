...
public class MenuPrincipal {
  ...
  public static final String ANSI_WHITE_BACKGROUND = "\u001B[47m";
    ...
    public void menuprincipal(){
       int y = lt1.leer(0, ANSI_CYAN_BACKGROUND+ANSI_BLACK+"\nElija el numero del ejercicio a ver:"+ANSI_RESET+"\n"+
        ...
        ANSI_YELLOW+"\n12"+ANSI_RESET+ANSI_GREEN+" = "+ANSI_RESET+ANSI_CYAN+"|Ejercicio 18|\n"+ANSI_RESET);
